...
% Auto-generated by ocrTrainer app on 22-Jun-2017
%-------------------------------------------------------
%
...
% ---------------------------------------------------
%  I = imread('D:\Github\StormMotion\OCR\im1.bmp');
%  figure
%  imshow(I)
%
...
trainedLanguage = 'D:\Github\StormMotion\Time\tessdata\Time.traineddata';
...
if isempty(deblank(text))
    ...
    J = insertText(I, [N/2 M/2], text, ...
        'AnchorPoint', 'Center', 'FontSize', 24, 'Font', 'Lucida Sans Unicode');
